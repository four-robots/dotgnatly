...
This is the core library for DotGnatly, containing the fundamental interfaces, abstractions, and configuration models that form the foundation of the message broker system.

## Purpose

DotGnatly.Core provides:
...
- Implementation libraries (e.g., DotGnatly.Nats)
